namespace SVPQA.UIModule.PQA.DataSelector.SmartViewDataSelectorClasses
{
    ...
    public partial class SmartViewDataSelector
    {
        ...
        /// <summary>
        /// ChangeDataBase - Use 'ChangeDataBaseParams' to pass parameters into this method.
        /// </summary>
        public void ChangeDataBase(bool isChanged, String server, String DB)
        {
            #region Variable Declarations
            WinButton uICOGNEXDBButton = this.UISmartViewDataSelectoWindow.UIBtnSelectDatabaseWindow.UICOGNEXDBButton;
            WinComboBox uIServerComboBox = this.UISelectDatabaseWindow.UICboxServerWindow.UIServerComboBox;
            WinComboBox uIDatabaseComboBox = this.UISelectDatabaseWindow.UICboxDatabaseWindow.UIDatabaseComboBox;
            WinButton uIOKButton = this.UISelectDatabaseWindow.UIOKWindow.UIOKButton;
            #endregion

            if (isChanged)
            {
                // Click 'COGNEXDB' button
                Mouse.Click(uICOGNEXDBButton, new Point(8, 10));

                // Select 'Cognex250' in 'Server:' combo box
                uIServerComboBox.SelectedItem = server;

                // Select 'COGNEXDB' in 'Database:' combo box
                uIDatabaseComboBox.EditableItem = DB;
        ...
        public virtual ChangeDataBaseParams ChangeDataBaseParams
        {
            get
            {
                if ((this.mChangeDataBaseParams == null))
                {
                    this.mChangeDataBaseParams = new ChangeDataBaseParams();
                }
                return this.mChangeDataBaseParams;
            }
        }

        private ChangeDataBaseParams mChangeDataBaseParams;
    }
    /// <summary>
    ...
    public class SearchByRecipeParams
    {
        ...
        /// Select 'Recipe' check box
        /// </summary>
        public bool UIRecipeCheckBoxChecked = false;
        #endregion
    }
    /// <summary>
    ...
    /// <summary>
    /// Parameters to be passed into 'ChangeDataBase'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "10.0.30319.1")]
    public class ChangeDataBaseParams
    {
        ...
        /// Select 'Cognex250' in 'Server:' combo box
        /// </summary>
        public string UIServerComboBoxSelectedItem = "Cognex250";

        /// <summary>
        /// Select 'COGNEXDB' in 'Database:' combo box
        /// </summary>
        public string UIDatabaseComboBoxEditableItem = "COGNEXDB";
        #endregion
}
}
