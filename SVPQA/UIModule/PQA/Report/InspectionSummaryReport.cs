namespace SVPQA.UIModule.PQA.Report.InspectionSummaryReportClasses
{
    ...
    public partial class InspectionSummaryReport
    {
        ...
        /// <summary>
        /// VerifyInspectionSummaryToolBarControls - Use 'VerifyInspectionSummaryToolBarControlsExpectedValues' to pass parameters into this method.
        /// </summary>
        public void VerifyInspectionSummaryToolBarControls()
        {
            #region Variable Declarations
            WinButton uIRunreportButton = this.UISmartViewProductionQWindow.UIInspectionSummaryWindow.UIToolBarPreviewWindow.UIRunreportButton;
            WinButton uIWizardButton = this.UISmartViewProductionQWindow.UIInspectionSummaryWindow.UIToolBarPreviewWindow.UIWizardButton;
            WinButton uIExportButton = this.UISmartViewProductionQWindow.UIInspectionSummaryWindow.UIToolBarPreviewWindow.UIExportButton;
            WinButton uIExcelWorkbookButton = this.UISmartViewProductionQWindow.UIInspectionSummaryWindow.UIToolBarPreviewWindow.UIExcelWorkbookButton;
            #endregion

            uIRunreportButton.WaitForControlEnabled();
            uIWizardButton.WaitForControlEnabled();
            uIExportButton.WaitForControlEnabled();
            uIExcelWorkbookButton.WaitForControlEnabled();

            // Verify that 'Run report' button's property 'Enabled' equals 'True'
            Assert.AreEqual(this.VerifyInspectionSummaryToolBarControlsExpectedValues.UIRunreportButtonEnabled, uIRunreportButton.Enabled);

            // Verify that 'Wizard' button's property 'Enabled' equals 'True'
            Assert.AreEqual(this.VerifyInspectionSummaryToolBarControlsExpectedValues.UIWizardButtonEnabled, uIWizardButton.Enabled);

            // Verify that 'Export' button's property 'Enabled' equals 'True'
            Assert.AreEqual(this.VerifyInspectionSummaryToolBarControlsExpectedValues.UIExportButtonEnabled, uIExportButton.Enabled);

            // Verify that 'Excel Workbook' button's property 'Enabled' equals 'True'
            Assert.AreEqual(this.VerifyInspectionSummaryToolBarControlsExpectedValues.UIExcelWorkbookButtonEnabled, uIExcelWorkbookButton.Enabled);
        }

        public virtual VerifyInspectionSummaryToolBarControlsExpectedValues VerifyInspectionSummaryToolBarControlsExpectedValues
        {
            get
            {
                if ((this.mVerifyInspectionSummaryToolBarControlsExpectedValues == null))
                {
                    this.mVerifyInspectionSummaryToolBarControlsExpectedValues = new VerifyInspectionSummaryToolBarControlsExpectedValues();
                }
                return this.mVerifyInspectionSummaryToolBarControlsExpectedValues;
            }
        }

        private VerifyInspectionSummaryToolBarControlsExpectedValues mVerifyInspectionSummaryToolBarControlsExpectedValues;
    }
    /// <summary>
    ...
    /// <summary>
    /// Parameters to be passed into 'VerifyInspectionSummaryToolBarControls'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "10.0.30319.1")]
    public class VerifyInspectionSummaryToolBarControlsExpectedValues
    {
        ...
        /// Verify that 'Excel Workbook' button's property 'Enabled' equals 'True'
        /// </summary>
        public bool UIExcelWorkbookButtonEnabled = true;
        #endregion
}
}
