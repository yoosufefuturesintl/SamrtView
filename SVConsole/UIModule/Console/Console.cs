namespace SVConsole.UIModule.Console.ConsoleClasses
{
    ...
    public partial class Console
    {
        ...
        public virtual CloseSVConsoleParams CloseSVConsoleParams
        {
            get
            {
                if ((this.mCloseSVConsoleParams == null))
                {
                    this.mCloseSVConsoleParams = new CloseSVConsoleParams();
                }
                return this.mCloseSVConsoleParams;
            }
        }

        private CloseSVConsoleParams mCloseSVConsoleParams;
    }
    /// <summary>
    ...
    /// <summary>
    /// Parameters to be passed into 'CloseSVConsole'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "10.0.30319.1")]
    public class CloseSVConsoleParams
    {
        ...
        /// Select 'Console.exe *32' in 'Unknown Name' list box
        /// </summary>
        public string UIItemListSelectedItemsAsString = "Console.exe *32";
        #endregion
}
}
