...
namespace SmartView
{
    ...
    public class TestRecipe:RecipeTestBase
    {
        ...
        {
            TestCaseExternalID = "CGN-53";
            Applications.CloseAllApplication("RecipeManager"); 
            RecipeWizard.LaunchRecipe(RecipeExePath, RecipeAlternateExePath);
            RecipeWizard.SelectArchitectureInRecipeWizard("Cognex Hayward E");
            RecipeWizard.SelectExistingRecipe("test");
            Recipe.VerifyRecipeMangerLaunchedSuecessfully("Cognex Hayward E", "test");
